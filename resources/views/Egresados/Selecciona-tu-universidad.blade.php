...
<head>
  ...
  <link rel="stylesheet" href="{{asset('css/Egresados/Selecciona-tu-universidad.css')}}" />
          ...
          <div class="main-form">
            <div class="text-container">
              ...
              <div class="body--main-text">
                <p>Hola! Estás a punto de iniciar tu registro en el Sistema de
                  Seguimiento de Egresados y Bolsa de Trabajo del SUNEO, de
                  antemano te agradecemos por colaborar cordialmente con tu
                  universidad.</p>
              </div>
            ...
            <div class="img-container">
              <a href="#modal"><img src="../assets/img/utm_u31.png" alt="" class="logo--school"></a>
              <a href="#modal"></a><img src="../assets/img/umar_u33.png" alt="" class="logo--school"></a>
              <img src="../assets/img/unistmo_u37.png" alt="" class="logo--school" />
              <img src="../assets/img/unpa_u38.png" alt="" class="logo--school" />
              <img src="../assets/img/unsis_u40.png" alt="" class="logo--school" />
              <img src="../assets/img/unsij_u39.png" alt="" class="logo--school" />
              <img src="../assets/img/unca_u34.png" alt="" class="logo--school" />
              <img src="../assets/img/nova_u32.png" alt="" class="logo--school" />
              <img src="../assets/img/uncos_u35.png" alt="" class="logo--school" />
              <a href="#modal"></a><img src="../assets/img/unicha_u36.png" alt="" class="logo--school"></a>
            </div>
