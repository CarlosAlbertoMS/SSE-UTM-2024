...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/empresas/datos-de-la-empresa-ofertas-laborales.css') }}">
</head>
<body>
    ...
    <section id="contenido">
        ...
        <section id="contenido--opciones">
            ...
            <div id="cinta--opciones">
                <ul>
                    <a href="Ofertas--Laborales-CrearOferta.html" style="color:#9ba266;" >
                    ...
                    <a href="Crear-oferta-editar.html" style="color: #6b6b6b;">
