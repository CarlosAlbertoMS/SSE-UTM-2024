          ...
          <div class="content2">
            <div class="content2--information">
              <div class="content2--information-title1">
                <p>Datos de la empresa <a class="content2--referencia" href="{{ route('empresa.edit') }}"><input type="button" class="boton--editar" name="btn1" value="Editar datos de la empresa"></a></p>
