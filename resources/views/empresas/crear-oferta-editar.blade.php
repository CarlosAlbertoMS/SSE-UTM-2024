...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/empresas/Crear-oferta-editar.css') }}">
</head>
...
<body>
    ...
    <section id="contenido">
        <section id="contenido--header">
            <div class="contenido--header--texto">Editar oferta de trabajo</div>
        </section>
        <form action="">
            <section id="contenido--formulario">
                <section id="contenido--formulario-texto">
                    <section id="formulario--texto-principal">
                        ...
                        <section id="formulario--texto-izq">
                            <div class="texto--izq-campos">
                                ...
                                <div class="campo--der">
                                    <input type="text" class="campo--der-boton" placeholder="Nombre de la oferta" value="Supervisor administrativo">
                                </div>
                            </div>
                            ...
                            <div class="texto--izq-campos">
                                ...
                                <div class="campo--der">
                                    <input type="text" class="campo--der-boton" placeholder="Puesto vacante" value="Puesto vacante">
                                </div>
                            </div>
                            ...
                            <div class="texto--izq-campos">
                                ...
                                <div class="campo--der">
                                    <input type="radio" name="sistema" class="radio-buttom">
                                    <p class="radio-text">UTM</p>
                                    <input type="radio" name="sistema" class="radio-buttom" checked>
                                    <p class="radio-text">SUNEO</p>
                                </div>
                            </div>
                            ...
                            <div class="texto--izq-campos">
                                ...
                                <div class="campo--der">
                                    <select class="campo--der-select">
                                        ...
                                        <option value="7" selected>Ingeniería Industrial</option>
                            ...
                            <div class="texto--izq-campos">
                                ...
                                <div class="campo--der">
                                    <input type="text" class="campo--der-boton" placeholder="Colonia, Ciudad o Estado" value="5 de Mayo, Col. Centro, Huajuapan de León, Oaxaca.">
                                </div>
                            </div>
                            ...
                            <div class="texto--izq-campos">
                                ...
                                <div class="campo--der">
                                    <input type="text" class="campo--der-boton" placeholder="Experiencia mínima para el puesto" value="3 años de experiencia">
                                </div>
                            </div>
                            ...
                            <div class="texto--izq-campos">
                                ...
                                <div class="campo--der">
                                    <input type="text" class="campo--der-boton" placeholder="$0-$0000" value="$70,0000">
                                </div>
                            </div>
                            ...
                            <div class="texto--izq-campos">
                                ...
                                <div class="campo--der">
                                    <select class="campo--der-select--2">
                                        ...
                                        <option value="1" selected>Vacante</option>
                    ...
                    <section id="formulario--texto-descrip">
                        ...
                        <input class="texto--descrip-oferta" type="text" name="" value="Descripción del puesto. Ganas de aprender. Sería bueno que sepas: - Funcionamiento básico de un parser/lexer. Estas son las herramientas que utilizamos: - Git - IntelliJ - Programamos en Erlang (ntp, aquí aprendes). - A veces C y java. Metodología - Agile - Test Driven Development Vacante en: Guadalajara, (puede ser remoto después de prueba).">
                    </section>
                    ...
                    <section id="formulario--texto-boton">
                        ...
                        <a href="#modal" class="texto--boton-buton1">
                            <span class="content1--more_coments-text"> Publicar oferta </span>
                        </a>
                    </section>
                </section>
            </section>
    ...
    <aside id="modal" class="modal--container">
        <div class="content-modal">
            ...
            <div class="modal--container-buttons">
                <a href="Datos-de-la-empresa-Ofertas-Laborales.html" class="modal-button3">
